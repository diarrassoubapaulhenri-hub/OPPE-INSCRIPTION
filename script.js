...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('deletePersonnelBtn').addEventListener('click', deletePersonnel);
...
function updateDatabaseInfo() {
    ...
    document.getElementById('dbPersonnel').textContent = totalPersonnel;
    document.getElementById('lastBackup').textContent = lastBackup ? 
        new Date(lastBackup).toLocaleDateString('fr-FR') : 'Jamais';
    document.getElementById('storageUsed').textContent = `${Math.round(storageSize / 1024)} Ko`;
}
